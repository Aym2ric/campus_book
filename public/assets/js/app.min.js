!function (e, t) {
    ...
    function f() {
        te.removeEventListener("DOMContentLoaded", f), e.removeEventListener("load", f), pe.ready()
    }
    ...
    function p(e, t, n) {
        var i;
        if (void 0 === n && 1 === e.nodeType) if (i = "data-" + t.replace(He, "-$&").toLowerCase(), "string" == typeof (n = e.getAttribute(i))) {
            try {
                n = h(n)
            } catch (e) {
            }
    ...
    function w(e, t, n, i, r) {
        for (var o, s, a, l, c, u, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++) if ((o = e[h]) || 0 === o) if ("object" === pe.type(o)) pe.merge(d, o.nodeType ? [o] : o); else if (Xe.test(o)) {
            for (s = s || f.appendChild(t.createElement("div")), a = (Ke.exec(o) || ["", ""])[1].toLowerCase(), l = ze[a] || ze._default, s.innerHTML = l[1] + pe.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            pe.merge(d, s.childNodes), (s = f.firstChild).textContent = ""
        } else d.push(t.createTextNode(o));
        for (f.textContent = "", h = 0; o = d[h++];) if (i && pe.inArray(o, i) > -1) r && r.push(o); else if (c = pe.contains(o.ownerDocument, o), s = y(f.appendChild(o), "script"), c && b(s), n) for (u = 0; o = s[u++];) $e.test(o.type || "") && n.push(o);
        return f
    }
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Le.hasData(e) && (o = Le.access(e), s = Le.set(t, o), c = o.events)) {
                ...
                for (r in c) for (n = 0, i = c[r].length; n < i; n++) pe.event.add(t, r, c[r][n])
            }
    ...
    function N(e, t, i, r) {
        ...
        if (m || d > 1 && "string" == typeof p && !de.checkClone && tt.test(p)) return e.each(function (n) {
            var o = e.eq(n);
            m && (t[0] = p.call(this, n, o.html())), N(o, t, i, r)
        });
        if (d && (o = w(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
            for (l = (a = pe.map(y(o, "script"), S)).length; f < d; f++) c = o, f !== h && (c = pe.clone(c, !0, !0), l && pe.merge(a, y(c, "script"))), i.call(e[f], c, f);
            if (l) for (u = a[a.length - 1].ownerDocument, pe.map(a, j), f = 0; f < l; f++) c = a[f], $e.test(c.type || "") && !Le.access(c, "globalEval") && pe.contains(u, c) && (c.src ? pe._evalUrl && pe._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    ...
    function O(e, t, n) {
        ...
        return (n = n || st(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || pe.contains(e.ownerDocument, e) || (s = pe.style(e, t)), !de.pixelMarginRight() && ot.test(s) && rt.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function H(e, t, n, i, r) {
        var o, s = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (s += pe.css(e, n + Fe[o], !0, r)), i ? ("content" === n && (s -= pe.css(e, "padding" + Fe[o], !0, r)), "margin" !== n && (s -= pe.css(e, "border" + Fe[o] + "Width", !0, r))) : (s += pe.css(e, "padding" + Fe[o], !0, r), "padding" !== n && (s += pe.css(e, "border" + Fe[o] + "Width", !0, r)));
        return s
    }
    ...
    function Q(e, t) {
        var n, i, r, o, s;
        for (n in e) if (i = pe.camelCase(n), r = t[i], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = pe.cssHooks[i]) && "expand" in s) {
    ...
    function K(e, t, n) {
        var i, r, o = 0, s = K.prefilters.length, a = pe.Deferred().always(function () {
            ...
            if (r) return !1;
            for (var t = ht || W(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++) c.tweens[o].run(i);
        ...
        for (Q(u, c.opts.specialEasing); o < s; o++) if (i = K.prefilters[o].call(c, e, u, c.opts)) return pe.isFunction(i.stop) && (pe._queueHooks(c.elem, c.opts.queue).stop = pe.proxy(i.stop, i)), i;
    ...
    function X(e, t, n, i) {
        ...
        }); else if (n || "object" !== pe.type(t)) i(e, t); else for (r in t) X(e + "[" + r + "]", t[r], n, i)
    }
    ...
    var ee = [], te = e.document, ne = Object.getPrototypeOf, ie = ee.slice, re = ee.concat, oe = ee.push,
        se = ee.indexOf, ae = {}, le = ae.toString, ce = ae.hasOwnProperty, ue = ce.toString, fe = ue.call(Object),
        de = {}, he = "3.2.1", pe = function (e, t) {
            return new pe.fn.init(e, t)
        }, me = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ge = /^-ms-/, ve = /-([a-z])/g, ye = function (e, t) {
            return t.toUpperCase()
        };
    pe.fn = pe.prototype = {
        jquery: he, constructor: pe, length: 0, toArray: function () {
            return ie.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || pe.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], i = e[t], s !== i && (c && i && (pe.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && pe.isPlainObject(n) ? n : {}, s[t] = pe.extend(c, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, pe.extend({
    ...
    var be = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : M) !== k && N(t), t = t || k, I)) {
        ...
        function d(e, t, n) {
            var i = t.dir, r = t.next, o = r || i, s = n && "parentNode" === o, a = W++;
            return t.first ? function (t, n, r) {
                ...
                } else for (; t = t[i];) if (1 === t.nodeType || s) if (f = t[R] || (t[R] = {}), u = f[t.uniqueID] || (f[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t; else {
        ...
        function g(e, t, n, r, o, s) {
            return r && !r[R] && (r = g(r)), o && !o[R] && (o = g(o, s)), i(function (i, s, a, l) {
                var c, u, f, d = [], h = [], g = s.length, v = i || p(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !i && t ? v : m(v, d, e, a, l), b = n ? o || (i ? e : g || r) ? [] : s : y;
                if (n && n(y, b, a, l), r) for (c = m(b, h), r(c, [], a, l), u = c.length; u--;) (f = c[u]) && (b[h[u]] = !(y[h[u]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
        ...
        function v(e) {
            for (var t, n, i, r = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = d(function (e) {
                ...
                return t = null, r
            }]; a < r; a++) if (n = _.relative[e[a].type]) u = [d(h(u), n)]; else {
                if ((n = _.filter[e[a].type].apply(null, e[a].matches))[R]) {
                    for (i = ++a; i < r && !_.relative[e[i].type]; i++) ;
                    return g(a > 1 && h(u), a > 1 && f(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(oe, "$1"), n, a < i && v(e.slice(a, i)), i < r && v(e = e.slice(i)), i < r && f(e))
                }
                u.push(n)
            }
            return h(u)
        ...
        function y(e, n) {
            var r = n.length > 0, o = e.length > 0, s = function (i, s, a, l, c) {
                var u, f, d, h = 0, p = "0", g = i && [], v = [], y = j, b = i || o && _.find.TAG("*", c),
                    w = F += null == y ? 1 : Math.random() || .1, E = b.length;
                for (c && (j = s === k || s || c); p !== E && null != (u = b[p]); p++) {
                    if (o && u) {
                        for (f = 0, s || u.ownerDocument === k || (N(u), a = !I); d = e[f++];) if (d(u, s || k, a)) {
                            l.push(u);
                            break
                        }
                        c && (F = w)
        ...
        var b, w, _, E, x, T, C, S, j, A, D, N, k, O, I, L, P, q, H, R = "sizzle" + 1 * new Date, M = e.document, F = 0,
            W = 0, U = n(), B = n(), Q = n(), K = function (e, t) {
                return e === t && (D = !0), 0
        ...
        try {
            Y.apply(z = G.call(M.childNodes), M.childNodes), z[M.childNodes.length].nodeType
        } catch (e) {
            Y = {
        ...
        w = t.support = {}, x = t.isXML = function (e) {
            ...
            return i !== k && 9 === i.nodeType && i.documentElement ? (k = i, O = k.documentElement, I = !x(k), M !== k && (n = k.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _e, !1) : n.attachEvent && n.attachEvent("onunload", _e)), w.attributes = r(function (e) {
            ...
            }), w.getElementsByClassName = pe.test(k.getElementsByClassName), w.getById = r(function (e) {
            ...
            }, P = [], L = [], (w.qsa = pe.test(k.querySelectorAll)) && (r(function (e) {
            ...
            }), L = L.length && new RegExp(L.join("|")), P = P.length && new RegExp(P.join("|")), t = pe.test(O.compareDocumentPosition), H = t || pe.test(O.contains) ? function (e, t) {
                ...
                if (!r || !o) return e === k ? -1 : t === k ? 1 : r ? -1 : o ? 1 : A ? J(A, e) - J(A, t) : 0;
                if (r === o) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== k && N(e), n = n.replace(le, "='$1']"), w.matchesSelector && I && !Q[n + " "] && (!P || !P.test(n)) && (!L || !L.test(n))) try {
                var i = q.call(e, n);
            ...
            var t, n = [], i = 0, r = 0;
            if (D = !w.detectDuplicates, A = !w.sortStable && e.slice(0), e.sort(K), D) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        var c, u, f, d, h, p, m = o !== s ? "nextSibling" : "previousSibling", g = t.parentNode,
                        ...
                        if (g) {
                            ...
                            if (p = [s ? g.firstChild : g.lastChild], s && y) {
                                for (b = (h = (c = (u = (f = (d = g)[R] || (d[R] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === F && c[1]) && c[2], d = h && g.childNodes[h]; d = ++h && d && d[m] || (b = h = 0) || p.pop();) if (1 === d.nodeType && ++b && d === t) {
                                    u[e] = [F, h, b];
                                    break
                                }
                            } else if (y && (d = t, f = d[R] || (d[R] = {}), u = f[d.uniqueID] || (f[d.uniqueID] = {}), c = u[e] || [], h = c[0] === F && c[1], b = h), !1 === b) for (; (d = ++h && d && d[m] || (b = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (f = d[R] || (d[R] = {}), u = f[d.uniqueID] || (f[d.uniqueID] = {}), u[e] = [F, b]), d !== t));) ;
        ...
        return u.prototype = _.filters = _.pseudos, _.setFilters = new u, T = t.tokenize = function (e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (r = fe.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !_.relative[a = s.type]);) if ((l = _.find[a]) && (i = l(s.matches[0].replace(ve, ye), ge.test(o[0].type) && c(t.parentNode) || t))) {
                    if (o.splice(r, 1), !(e = i.length && f(o))) return Y.apply(n, i), n;
                    break
                }
            }
            return (u || C(e, d))(i, t, !I, n, !t || ge.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = R.split("").sort(K).join("") === R, w.detectDuplicates = !!D, N(), w.sortDetached = r(function (e) {
    ...
    var we = function (e, t, n) {
            ...
            return n
        }, Ee = pe.expr.match.needsContext, xe = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
        Te = /^.[^:#\[\.,]*$/;
    ...
    (pe.fn.init = function (e, t, n) {
        ...
        if (n = n || Ce, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof pe ? t[0] : t, pe.merge(this, pe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)), xe.test(i[1]) && pe.isPlainObject(t)) for (i in t) pe.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    pe.fn.extend({
        has: function (e) {
            ...
            if (!Ee.test(e)) for (; i < r; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && pe.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
        ...
        pe.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = pe.filter(i, r)), this.length > 1 && (Ae[e] || pe.uniqueSort(r), je.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var De = /[^\x20\t\r\n\f]+/g;
    pe.Callbacks = function (e) {
        ...
        Deferred: function (t) {
                            ...
                            return function () {
                                var a = this, u = arguments, f = function () {
                                    ...
                                    if (!(t < s)) {
                                        ...
                                        f = e && ("object" == typeof e || "function" == typeof e) && e.then, pe.isFunction(f) ? r ? f.call(e, o(s, n, l, r), o(s, n, c, r)) : (s++, f.call(e, o(s, n, l, r), o(s, n, c, r), o(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [e]), (r || n.resolveWith)(a, u))
                                    }
                                }, d = r ? f : function () {
                                    try {
                                        f()
                                    } catch (e) {
                                        pe.Deferred.exceptionHook && pe.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= s && (i !== c && (a = void 0, u = [e]), n.rejectWith(a, u))
                                    }
                                };
            ...
            var t = arguments.length, n = t, i = Array(n), r = ie.call(arguments), o = pe.Deferred(), s = function (e) {
                return function (n) {
                    i[e] = this, r[e] = arguments.length > 1 ? ie.call(arguments) : n, --t || o.resolveWith(i, r)
                }
            };
            if (t <= 1 && (u(e, o.done(s(n)).resolve, o.reject, !t), "pending" === o.state() || pe.isFunction(r[n] && r[n].then))) return o.then();
    ...
    pe.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, ready: function (e) {
            (!0 === e ? --pe.readyWait : pe.isReady) || (pe.isReady = !0, !0 !== e && --pe.readyWait > 0 || ke.resolveWith(te, [pe]))
        }
    }), pe.ready.then = ke.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(pe.ready) : (te.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
    var Oe = function (e, t, n, i, r, o, s) {
        var a = 0, l = e.length, c = null == n;
        if ("object" === pe.type(n)) {
            r = !0;
            for (a in n) Oe(e, t, a, n[a], !0, o, s)
        } else if (void 0 !== i && (r = !0, pe.isFunction(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
    ...
    var Le = new d, Pe = new d, qe = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, He = /[A-Z]/g;
    pe.extend({
        hasData: function (e) {
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = Pe.get(o), 1 === o.nodeType && !Le.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = pe.camelCase(i.slice(5)), p(o, i, r[i]));
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = pe.queue(e, t), i = n.length, r = n.shift(), o = pe._queueHooks(e, t);
    ...
    var Re = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Me = new RegExp("^(?:([+-])=|)(" + Re + ")([a-z%]*)$", "i"),
        Fe = ["Top", "Right", "Bottom", "Left"], We = function (e, t) {
    ...
    var Qe = /^(?:checkbox|radio)$/i, Ke = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, $e = /^$|\/(?:java|ecma)script/i, ze = {
    ...
    var Ve = te.documentElement, Ye = /^key/, Ge = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Je = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {}, add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, f, d, h, p, m, g = Le.get(e);
            if (g) for (n.handler && (o = n, n = o.handler, r = o.selector), r && pe.find.matchesSelector(Ve, r), n.guid || (n.guid = pe.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                return void 0 !== pe && pe.event.triggered !== t.type ? pe.event.dispatch.apply(e, arguments) : void 0
            }), c = (t = (t || "").match(De) || [""]).length; c--;) a = Je.exec(t[c]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h && (f = pe.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = pe.event.special[h] || {}, u = pe.extend({
                type: h,
                origType: m,
                data: i,
                handler: n,
                ...
                namespace: p.join(".")
            }, o), (d = l[h]) || (d = l[h] = [], d.delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(h, s)), f.add && (f.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, u) : d.push(u), pe.event.global[h] = !0)
        }, remove: function (e, t, n, i, r) {
            var o, s, a, l, c, u, f, d, h, p, m, g = Le.hasData(e) && Le.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(De) || [""]).length; c--;) if (a = Je.exec(t[c]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h) {
                    for (f = pe.event.special[h] || {}, d = l[h = (i ? f.delegateType : f.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) u = d[o], !r && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(o, 1), u.selector && d.delegateCount--, f.remove && f.remove.call(e, u));
                    s && !d.length && (f.teardown && !1 !== f.teardown.call(e, p, g.handle) || pe.removeEvent(e, h, g.handle), delete l[h])
            ...
            var t, n, i, r, o, s, a = pe.event.fix(e), l = new Array(arguments.length),
                c = (Le.get(this, "events") || {})[a.type] || [], u = pe.event.special[a.type] || {};
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                for (o = [], s = {}, n = 0; n < l; n++) i = t[n], r = i.selector + " ", void 0 === s[r] && (s[r] = i.needsContext ? pe(r, this).index(c) > -1 : pe.find(r, this, null, [c]).length), s[r] && o.push(i);
        ...
        return this instanceof pe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? _ : E, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && pe.extend(this, t), this.timeStamp = e && e.timeStamp || pe.now(), void (this[pe.expando] = !0)) : new pe.Event(e, t)
    }, pe.Event.prototype = {
    ...
    pe.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (s = y(a), o = y(e), i = 0, r = o.length; i < r; i++) D(o[i], s[i]);
            if (t) if (n) for (o = o || y(e), s = s || y(a), i = 0, r = o.length; i < r; i++) A(o[i], s[i]); else A(e, a);
            return (s = y(a, "script")).length > 0 && b(s, !l && y(e, "script")), a
        }, cleanData: function (e) {
            for (var t, n, i, r = pe.event.special, o = 0; void 0 !== (n = e[o]); o++) if (Ie(n)) {
                if (t = n[Le.expando]) {
    ...
    var at = /^(none|table(?!-c[ea]).+)/, lt = /^--/,
        ...
        ut = {letterSpacing: "0", fontWeight: "400"}, ft = ["Webkit", "Moz", "ms"], dt = te.createElement("div").style;
    pe.extend({
        cssHooks: {
            opacity: {
                get: function (e, t) {
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return l || (t = P(a)), s = pe.cssHooks[t] || pe.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t] : ("string" === (o = typeof n) && (r = Me.exec(n)) && r[1] && (n = m(e, t, r), o = "number"), void (null != n && n === n && ("number" === o && (n += r && r[3] || (pe.cssNumber[a] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = pe.camelCase(t);
            return lt.test(t) || (t = P(a)), (s = pe.cssHooks[t] || pe.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = O(e, t, i)), "normal" === r && t in ut && (r = ut[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), pe.each(["height", "width"], function (e, t) {
        pe.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !at.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? R(e, t, i) : Ue(e, ct, function () {
                    return R(e, t, i)
                })
            }, set: function (e, n, i) {
                var r, o = i && st(e), s = i && H(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, o), o);
                return s && (r = Me.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), q(0, n, s)
            }
        }
        ...
        css: function (e, t) {
            return Oe(this, function (e, t, n) {
                var i, r, o = {}, s = 0;
                if (Array.isArray(t)) {
                    for (i = st(e), r = t.length; s < r; s++) o[t[s]] = pe.css(e, t[s], !1, i);
                    return o
                }
        ...
        constructor: M, init: function (e, t, n, i, r, o) {
    ...
    pe.Animation = pe.extend(K, {
        tweeners: {
            ...
            var i, r, o, s, a, l, c, u, f = "width" in t || "height" in t, d = this, h = {}, p = e.style,
                m = e.nodeType && We(e), g = Le.get(e, "fxshow");
            ...
            if ((l = !pe.isEmptyObject(t)) || !pe.isEmptyObject(h)) {
                f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = Le.get(e, "display")), "none" === (u = pe.css(e, "display")) && (c ? u = c : (v([e], !0), c = e.style.display || c, u = pe.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === pe.css(e, "float") && (l || (d.done(function () {
                    p.display = c
                }), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
                    p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                })), l = !1;
                for (i in h) l || (g ? "hidden" in g && (m = g.hidden) : g = Le.access(e, "fxshow", {display: c}), o && (g.hidden = !m), m && v([e], !0), d.done(function () {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, r = null != e && e + "queueHooks", o = pe.timers, s = Le.get(this);
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = Le.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = pe.timers,
                    s = i ? i.length : 0;
    ...
    pe.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? pe.prop(e, t, n) : (1 === o && pe.isXMLDoc(e) || (r = pe.attrHooks[t.toLowerCase()] || (pe.expr.match.bool.test(t) ? vt : void 0)), void 0 !== n ? null === n ? void pe.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = pe.find.attr(e, t)) ? void 0 : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    pe.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(De) || []; n = this[l++];) if (r = z(n), i = 1 === n.nodeType && " " + $(r) + " ") {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, o;
                if ("string" === n) for (i = 0, r = pe(this), o = e.match(De) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = z(this)) && Le.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Le.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];) if (1 === n.nodeType && (" " + $(z(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var _t = /\r/g;
    ...
    pe.extend(pe.event, {
        trigger: function (t, n, i, r) {
            var o, s, a, l, c, u, f, d = [i || te], h = ce.call(t, "type") ? t.type : t,
                p = ce.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !Et.test(h + pe.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[pe.expando] ? t : new pe.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), f = pe.event.special[h] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!r && !f.noBubble && !pe.isWindow(i)) {
                    for (l = f.delegateType || h, Et.test(l + h) || (s = s.parentNode); s; s = s.parentNode) d.push(s), a = s;
                    a === (i.ownerDocument || te) && d.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || h, (u = (Le.get(s, "events") || {})[t.type] && Le.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && Ie(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = h, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Ie(i) || c && pe.isFunction(i[h]) && !pe.isWindow(i) && ((a = i[c]) && (i[c] = null), pe.event.triggered = h, i[h](), pe.event.triggered = void 0, a && (i[c] = a)), t.result
            }
    ...
    }), de.focusin = "onfocusin" in e, de.focusin || pe.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
            pe.event.simulate(t, e.target, pe.event.fix(e))
        };
        pe.event.special[t] = {
            setup: function () {
                var i = this.ownerDocument || this, r = Le.access(i, t);
                r || i.addEventListener(e, n, !0), Le.access(i, t, (r || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, r = Le.access(i, t) - 1;
                r ? Le.access(i, t, r) : (i.removeEventListener(e, n, !0), Le.remove(i, t))
            }
        }
    });
    var xt = e.location, Tt = pe.now(), Ct = /\?/;
    ...
    var Nt = /%20/g, kt = /#.*$/, Ot = /([?&])_=[^&]*/, It = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, qt = /^\/\//, Ht = {},
        Rt = {}, Mt = "*/".concat("*"), Ft = te.createElement("a");
    Ft.href = xt.href, pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, n) {
            function i(t, n, i, a) {
                var c, d, h, w, _, E = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, s = a || "", x.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (w = J(p, x, i)), w = Z(p, w, x, c), c ? (p.ifModified && ((_ = x.getResponseHeader("Last-Modified")) && (pe.lastModified[o] = _), (_ = x.getResponseHeader("etag")) && (pe.etag[o] = _)), 204 === t || "HEAD" === p.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = w.state, d = w.data, h = w.error, c = !h)) : (h = E, !t && E || (E = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (n || E) + "", c ? v.resolveWith(m, [d, E, x]) : v.rejectWith(m, [x, E, h]), x.statusCode(b), b = void 0, f && g.trigger(c ? "ajaxSuccess" : "ajaxError", [x, p, c ? d : h]), y.fireWith(m, [x, E]), f && (g.trigger("ajaxComplete", [x, p]), --pe.active || pe.event.trigger("ajaxStop")))
            }

            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, o, s, a, l, c, u, f, d, h, p = pe.ajaxSetup({}, n), m = p.context || p,
                g = p.context && (m.nodeType || m.jquery) ? pe(m) : pe.event, v = pe.Deferred(),
                y = pe.Callbacks("once memory"), b = p.statusCode || {}, w = {}, _ = {}, E = "canceled", x = {
            ...
            if (v.promise(x), p.url = ((t || p.url || xt.href) + "").replace(qt, xt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(De) || [""], null == p.crossDomain) {
    ...
    var Wt = {0: 200, 1223: 204}, Ut = pe.ajaxSettings.xhr();
    de.cors = !!Ut && "withCredentials" in Ut, de.ajax = Ut = !!Ut, pe.ajaxTransport(function (t) {
        var n, i;
    ...
    pe.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Qt, "$1" + r) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return s || pe.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === o ? pe(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Bt.push(r)), s && pe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script"
        ...
        var i, r, o;
        return t || (de.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = xe.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = w([e], t, o), o && o.length && pe(o).remove(), pe.merge([], r.childNodes))
    }, pe.fn.load = function (e, t, n) {
        var i, r, o, s = this, a = e.indexOf(" ");
        return a > -1 && (i = $(e.slice(a)), e = e.slice(0, a)), pe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && pe.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === c && (e.style.position = "relative"), a = u.offset(), o = pe.css(e, "top"), l = pe.css(e, "left"), ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (i = u.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), pe.isFunction(t) && (t = t.call(e, n, pe.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : u.css(f)
        }
    }, pe.fn.extend({
        offset: function (e) {
        ...
        pe.cssHooks[t] = I(de.pixelPosition, function (e, n) {
            if (n) return n = O(e, t), ot.test(n) ? pe(e).position()[t] + "px" : n
        })
    ...
    return pe.noConflict = function (t) {
        return e.$ === pe && (e.$ = $t), t && e.jQuery === pe && (e.jQuery = Kt), pe
    }, t || (e.jQuery = e.$ = pe), pe
}), function (e, t) {
    ...
    function p(e) {
        ...
        var o = {left: n.left, top: n.top, width: n.right - n.left, height: n.bottom - n.top},
            s = "HTML" === e.nodeName ? d() : {}, a = s.width || e.clientWidth || o.right - o.left,
            c = s.height || e.clientHeight || o.bottom - o.top, f = e.offsetWidth - a, p = e.offsetHeight - c;
        if (f || p) {
            var m = t(e);
    ...
    function m(e, n) {
        var r = te(), o = "HTML" === n.nodeName, s = p(e), a = p(n), l = i(e), u = t(n),
            f = +u.borderTopWidth.split("px")[0], d = +u.borderLeftWidth.split("px")[0],
            m = h({top: s.top - a.top - f, left: s.left - a.left - d, width: s.width, height: s.height});
        if (m.marginTop = 0, m.marginLeft = 0, !r && o) {
            var g = +u.marginTop.split("px")[0], v = +u.marginLeft.split("px")[0];
    ...
    function g(e) {
        var t = window.document.documentElement, n = m(e, t), i = z(t.clientWidth, window.innerWidth || 0),
            r = z(t.clientHeight, window.innerHeight || 0), o = l(t), s = l(t, "left");
    ...
    function A() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = _(this.state, this.popper, this.reference), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = T(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = j(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function O(e, t, n, r) {
        ...
        s.addEventListener(t, n, {passive: !0}), o || O(i(s.parentNode), t, n, r), r.push(s)
    }
    ...
    for (var K = Math.min, $ = Math.floor, z = Math.max, X = ["native code", "[object MutationObserverConstructor]"], V = "undefined" != typeof window, Y = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < Y.length; J += 1) if (V && 0 <= navigator.userAgent.indexOf(Y[J])) {
        G = 1;
        break
    }
            ...
            shift: {
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    var n, i = t.offset, r = e.placement, o = e.offsets, s = o.popper, a = o.reference,
                        l = r.split("-")[0];
                    return n = H(+i) ? [+i, 0] : Q(i, s, a, l), "left" === l ? (s.top += n[0], s.left -= n[1]) : "right" === l ? (s.top += n[0], s.left += n[1]) : "top" === l ? (s.left += n[0], s.top -= n[1]) : "bottom" === l && (s.left += n[0], s.top += n[1]), e.popper = s, e
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (e, t) {
                    ...
                    var o = t.priority, s = e.offsets.popper, a = {
                        primary: function (e) {
                            var n = s[e];
                            return s[e] < i[e] && !t.escapeWithReference && (n = z(s[e], i[e])), re({}, e, n)
                        }, secondary: function (e) {
                            var n = "right" === e ? "left" : "top", r = s[n];
                            return s[e] > i[e] && !t.escapeWithReference && (r = K(s[n], i[e] - ("right" === e ? s.width : s.height))), re({}, n, r)
                        }
                    };
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, s = o.popper, a = o.reference,
                        ...
                        f = u.toLowerCase(), d = l ? "left" : "top", p = l ? "bottom" : "right", m = E(i)[c];
                    a[p] - m < s[f] && (e.offsets.popper[f] -= s[f] - (a[p] - m)), a[f] + m > s[p] && (e.offsets.popper[f] += a[f] + m - s[p]);
                    var g = a[f] + a[c] / 2 - m / 2, v = t(e.instance.popper, "margin" + u).replace("px", ""),
                        y = g - h(e.offsets.popper)[f] - v;
                    return y = z(K(s[c] - m, y), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[f] = Math.round(y), e.offsets.arrow[d] = "", e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    var n = y(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement),
                        i = e.placement.split("-")[0], r = x(i), o = e.placement.split("-")[1] || "", s = [];
                    switch (t.behavior) {
                        case le.FLIP:
                            s = [i, r];
                            break;
                    ...
                    return s.forEach(function (a, l) {
                        ...
                        var c = e.offsets.popper, u = e.offsets.reference, f = $,
                        ...
                        (d || v || b) && (e.flipped = !0, (d || v) && (i = s[l + 1]), b && (o = W(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = oe({}, e.offsets.popper, T(e.instance.popper, e.offsets.reference, e.placement)), e = j(e.instance.modifiers, e, "flip"))
                    }), e
                ...
                order: 700, enabled: !1, fn: function (e) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = x(t), e.offsets.popper = h(r), e
                }
            }, hide: {
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var a, l, c = void 0 === s ? t.gpuAcceleration : s, u = p(r(e.instance.popper)),
                        f = {position: o.position},
                        d = {left: $(o.left), top: $(o.top), bottom: $(o.bottom), right: $(o.right)},
                        h = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right", g = N("transform");
                    if (l = "bottom" == h ? -u.height + d.bottom : d.top, a = "right" == m ? -u.width + d.right : d.left, c && g) f[g] = "translate3d(" + a + "px, " + l + "px, 0)", f[h] = 0, f[m] = 0, f.willChange = "transform"; else {
                        var v = "bottom" == h ? -1 : 1, y = "right" == m ? -1 : 1;
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), s = 0, a = o.length; s < a; s++) !function (e, n) {
            ...
            a.forEach(function (e) {
                (function (e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === Ae.indexOf(n) || Boolean(e.nodeValue.match(Ne) || e.nodeValue.match(ke));
    ...
    var c = "alert", u = "bs.alert", f = "." + u, d = t.fn[c],
        h = {CLOSE: "close" + f, CLOSED: "closed" + f, CLICK_DATA_API: "click" + f + ".data-api"}, p = function () {
            function e(e) {
                this._element = e
            }
    ...
    t(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', p._handleDismiss(new p)), t.fn[c] = p._jQueryInterface, t.fn[c].Constructor = p, t.fn[c].noConflict = function () {
        return t.fn[c] = d, p._jQueryInterface
    };
    var m = "button", g = "bs.button", v = "." + g, y = ".data-api", b = t.fn[m], w = "active",
        _ = '[data-toggle^="button"]', E = ".btn",
        x = {CLICK_DATA_API: "click" + v + y, FOCUS_BLUR_DATA_API: "focus" + v + y + " blur" + v + y}, T = function () {
            function e(e) {
                this._element = e
            }
    ...
    t(document).on(x.CLICK_DATA_API, _, function (e) {
        e.preventDefault();
        var n = e.target;
        t(n).hasClass("btn") || (n = t(n).closest(E)), T._jQueryInterface.call(t(n), "toggle")
    }).on(x.FOCUS_BLUR_DATA_API, _, function (e) {
        var n = t(e.target).closest(E)[0];
        t(n).toggleClass("focus", /^focus(in)?$/.test(e.type))
    }), t.fn[m] = T._jQueryInterface, t.fn[m].Constructor = T, t.fn[m].noConflict = function () {
        return t.fn[m] = b, T._jQueryInterface
    };
    var C = "carousel", S = "bs.carousel", j = "." + S, A = ".data-api", D = t.fn[C],
        N = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, k = {
        ...
        }, P = "active", q = ".active.carousel-item", H = ".carousel-indicators", R = {TOUCH: "touch", PEN: "pen"},
        M = function () {
            function e(e, t) {
            ...
            return n.next = function () {
                ...
                t(this._element).off(j), t.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, n._getConfig = function (e) {
                return e = o({}, N, e), l.typeCheckConfig(C, e, k), e
                ...
                var n = e === O, i = e === I, r = this._getItemIndex(t), o = this._items.length - 1;
                if ((i && 0 === r || n && r === o) && !this._config.wrap) return t;
                var s = (r + (e === I ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, n._triggerSlideEvent = function (e, n) {
                var i = this._getItemIndex(e), r = this._getItemIndex(this._element.querySelector(q)),
                    o = t.Event(L.SLIDE, {relatedTarget: e, direction: n, from: r, to: i});
                ...
                var i, r, o, s = this, a = this._element.querySelector(q), c = this._getItemIndex(a),
                    u = n || a && this._getItemByDirection(e, a), f = this._getItemIndex(u),
                    d = Boolean(this._interval);
                if (o = e === O ? (i = "carousel-item-left", r = "carousel-item-next", "left") : (i = "carousel-item-right", r = "carousel-item-prev", "right"), u && t(u).hasClass(P)) this._isSliding = !1; else if (!this._triggerSlideEvent(u, o).isDefaultPrevented() && a && u) {
                    this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(u);
                    var h = t.Event(L.SLID, {relatedTarget: u, direction: o, from: c, to: f});
                    if (t(this._element).hasClass("slide")) {
                        ...
                        t(a).one(l.TRANSITION_END, function () {
                            t(u).removeClass(i + " " + r).addClass(P), t(a).removeClass(P + " " + r + " " + i), s._isSliding = !1, setTimeout(function () {
                                return t(s._element).trigger(h)
                            }, 0)
                        }).emulateTransitionEnd(m)
                    } else t(a).removeClass(P), t(u).addClass(P), this._isSliding = !1, t(this._element).trigger(h);
                    d && this.cycle()
                }
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
                    var i = t(this).data(S), r = o({}, N, t(this).data());
                    "object" == typeof n && (r = o({}, r, n));
                    var s = "string" == typeof n ? n : r.slide;
                    if (i || (i = new e(this, r), t(this).data(S, i)), "number" == typeof n) i.to(n); else if ("string" == typeof s) {
                ...
                if (i) {
                    ...
                    if (r && t(r).hasClass("carousel")) {
                        ...
                        a && (s.interval = !1), e._jQueryInterface.call(t(r), s), a && t(r).data(S).to(a), n.preventDefault()
                    }
                }
            }, r(e, null, [{
                key: "VERSION", get: function () {
    ...
    }), t.fn[C] = M._jQueryInterface, t.fn[C].Constructor = M, t.fn[C].noConflict = function () {
        return t.fn[C] = D, M._jQueryInterface
    };
    var F = "collapse", W = "bs.collapse", U = "." + W, B = t.fn[F], Q = {toggle: !0, parent: ""},
        ...
        }, z = "show", X = "collapse", V = "collapsing", Y = "collapsed", G = '[data-toggle="collapse"]', J = function () {
            function e(e, t) {
            ...
            return n.toggle = function () {
                ...
                if (!(this._isTransitioning || t(this._element).hasClass(z) || (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
                    ...
                    if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                        ...
                        t(this._element).removeClass(X).addClass(V), this._element.style[s] = 0, this._triggerArray.length && t(this._triggerArray).removeClass(Y).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var a = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                            c = l.getTransitionDurationFromElement(this._element);
                        t(this._element).one(l.TRANSITION_END, function () {
                            t(r._element).removeClass(V).addClass(X).addClass(z), r._element.style[s] = "", r.setTransitioning(!1), t(r._element).trigger($.SHOWN)
                ...
                if (!this._isTransitioning && t(this._element).hasClass(z)) {
                    ...
                    if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", l.reflow(this._element), t(this._element).addClass(V).removeClass(X).removeClass(z);
                        ...
                        t(this._element).one(l.TRANSITION_END, function () {
                            e.setTransitioning(!1), t(e._element).removeClass(V).addClass(X).trigger($.HIDDEN)
                ...
                return (e = o({}, Q, e)).toggle = Boolean(e.toggle), l.typeCheckConfig(F, e, K), e
                ...
                return this.each(function () {
                    var i = t(this), r = i.data(W), s = o({}, Q, i.data(), "object" == typeof n && n ? n : {});
    ...
    t(document).on($.CLICK_DATA_API, G, function (e) {
        ...
        return t.fn[F] = B, J._jQueryInterface
    };
    var Z = "dropdown", ee = "bs.dropdown", te = "." + ee, ne = ".data-api", ie = t.fn[Z], re = new RegExp("38|40|27"),
        ...
        ue = ".dropdown-menu",
        fe = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, de = {
    ...
    var pe = "modal", me = "bs.modal", ge = "." + me, ve = t.fn[pe],
        ...
        }, _e = "modal-open", Ee = "fade", xe = "show", Te = ".modal-dialog",
        Ce = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Se = ".sticky-top", je = function () {
            function e(e, t) {
            ...
            return n.toggle = function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (r && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(we.FOCUSIN), t(this._element).removeClass(xe), t(this._element).off(we.CLICK_DISMISS), t(this._dialog).off(we.MOUSEDOWN_DISMISS), r) {
                ...
                return e = o({}, ye, e), l.typeCheckConfig(pe, e, be), e
            }, n._showElement = function (e) {
                var n = this, i = t(this._element).hasClass(Ee);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, i && l.reflow(this._element), t(this._element).addClass(xe), this._config.focus && this._enforceFocus();
                var r = t.Event(we.SHOWN, {relatedTarget: e}), o = function () {
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    t(document.body).removeClass(_e), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(we.HIDDEN)
                })
            }, n._removeBackdrop = function () {
                this._backdrop && (t(this._backdrop).remove(), this._backdrop = null)
            }, n._showBackdrop = function (e) {
                var n = this, i = t(this._element).hasClass(Ee) ? Ee : "";
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), i && l.reflow(this._backdrop), t(this._backdrop).addClass(xe), !e) return;
                    if (!i) return void e();
                ...
                if (this._isBodyOverflowing) {
                    var n = [].slice.call(document.querySelectorAll(Ce)), i = [].slice.call(document.querySelectorAll(Se));
                ...
                return this.each(function () {
                    var r = t(this).data(me), s = o({}, ye, t(this).data(), "object" == typeof n && n ? n : {});
                    if (r || (r = new e(this, s), t(this).data(me, r)), "string" == typeof n) {
                        if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                        r[n](i)
    ...
    }), t.fn[pe] = je._jQueryInterface, t.fn[pe].Constructor = je, t.fn[pe].noConflict = function () {
        return t.fn[pe] = ve, je._jQueryInterface
    };
    var Ae = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], De = {
        ...
        Oe = "tooltip", Ie = "bs.tooltip", Le = "." + Ie, Pe = t.fn[Oe], qe = "bs-tooltip",
        He = new RegExp("(^|\\s)" + qe + "\\S+", "g"), Re = ["sanitize", "whiteList", "sanitizeFn"], Me = {
            animation: "boolean",
            template: "string",
        ...
        }, Qe = "fade", Ke = "show", $e = "hover", ze = "focus", Xe = function () {
            function e(e, t) {
            ...
            return i.enable = function () {
                ...
                if (t(this.element).trigger(r), !r.isDefaultPrevented()) {
                    if (t(i).removeClass(Ke), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[ze] = !1, this._activeTrigger[$e] = !1, t(this.tip).hasClass(Qe)) {
                ...
                var i = this.constructor.DATA_KEY;
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? ze : $e] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = "out", n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
                ...
                return Object.keys(n).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), l.typeCheckConfig(Oe, e, this.constructor.DefaultType), e.sanitize && (e.template = s(e.template, e.whiteList, e.sanitizeFn)), e
            }, i._getDelegateConfig = function () {
                var e = {};
                if (this.config) for (var t in this.config) this.constructor.Default[t] !== this.config[t] && (e[t] = this.config[t]);
                return e
            }, i._cleanTipClass = function () {
                var e = t(this.getTipElement()), n = e.attr("class").match(He);
                ...
                null === e.getAttribute("x-placement") && (t(e).removeClass(Qe), this.config.animation = !1, this.hide(), this.show(), this.config.animation = n)
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
                    var i = t(this).data(Ie), r = "object" == typeof n && n;
    ...
    t.fn[Oe] = Xe._jQueryInterface, t.fn[Oe].Constructor = Xe, t.fn[Oe].noConflict = function () {
        return t.fn[Oe] = Pe, Xe._jQueryInterface
    };
    var Ve = "popover", Ye = "bs.popover", Ge = "." + Ye, Je = t.fn[Ve], Ze = "bs-popover",
    ...
    t.fn[Ve] = rt._jQueryInterface, t.fn[Ve].Constructor = rt, t.fn[Ve].noConflict = function () {
        return t.fn[Ve] = Je, rt._jQueryInterface
    };
    var ot = "scrollspy", st = "bs.scrollspy", at = "." + st, lt = t.fn[ot],
        ...
        ft = {ACTIVATE: "activate" + at, SCROLL: "scroll" + at, LOAD_DATA_API: "load" + at + ".data-api"},
        dt = "active", ht = ".nav, .list-group", pt = ".nav-link", mt = ".list-group-item", gt = ".dropdown-item",
        vt = "position", yt = function () {
            function e(e, n) {
                var i = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + pt + "," + this._config.target + " " + mt + "," + this._config.target + " " + gt, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(ft.SCROLL, function (e) {
                    return i._process(e)
            ...
            return n.refresh = function () {
                var e = this, n = this._scrollElement === this._scrollElement.window ? "offset" : vt,
                    i = "auto" === this._config.method ? n : this._config.method, r = i === vt ? this._getScrollTop() : 0;
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(dt), i.addClass(dt)) : (i.addClass(dt), i.parents(ht).prev(pt + ", " + mt).addClass(dt), i.parents(ht).prev(".nav-item").children(pt).addClass(dt)), t(this._scrollElement).trigger(ft.ACTIVATE, {relatedTarget: e})
            }, n._clear = function () {
    ...
    }), t.fn[ot] = yt._jQueryInterface, t.fn[ot].Constructor = yt, t.fn[ot].noConflict = function () {
        return t.fn[ot] = lt, yt._jQueryInterface
    };
    var bt = "bs.tab", wt = "." + bt, _t = t.fn.tab, Et = {
        HIDE: "hide" + wt,
        HIDDEN: "hidden" + wt,
        SHOW: "show" + wt,
        SHOWN: "shown" + wt,
        CLICK_DATA_API: "click" + wt + ".data-api"
    }, xt = "active", Tt = ".active", Ct = "> li > .active", St = function () {
        function e(e) {
            this._element = e
        }
        ...
        return n.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(xt) || t(this._element).hasClass("disabled"))) {
                ...
                var a = t.Event(Et.HIDE, {relatedTarget: this._element}), c = t.Event(Et.SHOW, {relatedTarget: i});
                if (i && t(i).trigger(a), t(this._element).trigger(c), !c.isDefaultPrevented() && !a.isDefaultPrevented()) {
                    ...
                    var u = function () {
                        var n = t.Event(Et.HIDDEN, {relatedTarget: e._element}),
                            r = t.Event(Et.SHOWN, {relatedTarget: i});
            ...
            if (n) {
                ...
                r && t(r).removeClass(xt), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1)
            }
            if (t(e).addClass(xt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), l.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
    ...
    t(document).on(Et.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
        ...
        return t.fn.tab = _t, St._jQueryInterface
    };
    var jt = "toast", At = "bs.toast", Dt = "." + At, Nt = t.fn[jt], kt = {
            CLICK_DISMISS: "click.dismiss" + Dt,
            HIDE: "hide" + Dt,
            HIDDEN: "hidden" + Dt,
            SHOW: "show" + Dt,
            SHOWN: "shown" + Dt
        }, Ot = "show", It = "showing", Lt = {animation: "boolean", autohide: "boolean", delay: "number"},
        Pt = {animation: !0, autohide: !0, delay: 500}, qt = function () {
            function e(e, t) {
            ...
            return n.show = function () {
                ...
                var n = function () {
                    e._element.classList.remove(It), e._element.classList.add(Ot), t(e._element).trigger(kt.SHOWN), e._config.autohide && e.hide()
                };
                ...
                var n = this;
                this._element.classList.contains(Ot) && (t(this._element).trigger(kt.HIDE), e ? this._close() : this._timeout = setTimeout(function () {
                    n._close()
                }, this._config.delay))
            }, n.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ot) && this._element.classList.remove(Ot), t(this._element).off(kt.CLICK_DISMISS), t.removeData(this._element, At), this._element = null, this._config = null
            }, n._getConfig = function (e) {
                return e = o({}, Pt, t(this._element).data(), "object" == typeof e && e ? e : {}), l.typeCheckConfig(jt, e, this.constructor.DefaultType), e
    ...
    t.fn[jt] = qt._jQueryInterface, t.fn[jt].Constructor = qt, t.fn[jt].noConflict = function () {
        return t.fn[jt] = Nt, qt._jQueryInterface
    }, function () {
        if (void 0 === t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var e = t.fn.jquery.split(" ")[0].split(".");
        if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(), e.Util = l, e.Alert = p, e.Button = T, e.Carousel = M, e.Collapse = J, e.Dropdown = he, e.Modal = je, e.Popover = rt, e.Scrollspy = yt, e.Tab = St, e.Toast = qt, e.Tooltip = Xe, Object.defineProperty(e, "__esModule", {value: !0})
}), function () {
    var e, t, n, i, r, o, s, a, l, c, u, f, d, h, p, m, g, v, y, b, w, _, E, x, T, C, S, j, A, D, N, k, O, I, L, P, q,
        H, R, M, F, W, U, B, Q, K, $, z, X, V = [].slice, Y = {}.hasOwnProperty, G = function (e, t) {
            function n() {
                this.constructor = e
            }
    ...
    for (w = {
        ...
        var e, t, n, i, r, o, s;
        for (t = arguments[0], o = 0, s = (i = 2 <= arguments.length ? V.call(arguments, 1) : []).length; s > o; o++) if (n = i[o]) for (e in n) Y.call(n, e) && (r = n[e], null != t[e] && "object" == typeof t[e] && null != r && "object" == typeof r ? _(t[e], r) : t[e] = r);
        return t
    }, g = function (e) {
        var t, n, i, r, o;
    ...
    }(), c = window.Pace || {}, window.Pace = c, _(c, s.prototype), D = c.options = _({}, w, window.paceOptions, x()), U = 0, Q = ($ = ["ajax", "document", "eventLag", "elements"]).length; Q > U; U++) q = $[U], !0 === D[q] && (D[q] = w[q]);
    l = function (e) {
        function t() {
        ...
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? V.call(arguments, 1) : [], S.unshift("ignore"), n = t.apply(null, e), S.shift(), n
    }, c.track = function () {
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? V.call(arguments, 1) : [], S.unshift("track"), n = t.apply(null, e), S.shift(), n
    }, P = function (e) {
        var t;
        ...
        function t() {
            ...
            t.__super__.constructor.apply(this, arguments), e = function (e) {
                ...
                return t = e.open, e.open = function (i, r) {
                    return P(i) && n.trigger("request", {type: i, url: r, request: e}), t.apply(e, arguments)
                }
        ...
        var t, n, i, r;
        for (n = 0, i = (r = D.ajax.ignoreURLs).length; i > n; n++) if ("string" == typeof (t = r[n])) {
        ...
        return e.prototype.watch = function (e) {
            var t, n, i, r;
            return i = e.type, t = e.request, r = e.url, L(r) ? void 0 : (n = "socket" === i ? new h(t) : new p(t), this.elements.push(n))
        }, e
    }(), p = function () {
        return function (e) {
            ...
            }, !1); else r = e.onreadystatechange, e.onreadystatechange = function () {
                var t;
        ...
        return function () {
            ...
            this.progress = 0, e = 0, r = [], i = 0, n = A(), t = setInterval(function () {
                var s;
                return s = A() - n - 50, n = A(), r.push(s), r.length > D.eventLag.sampleCount && r.shift(), e = g(r), ++i >= D.eventLag.minSamples && e < D.eventLag.lagThreshold ? (o.progress = 100, clearInterval(t)) : o.progress = 3 / (e + 3) * 100
            }, 50)
        }
    }(), d = function () {
        function e(e) {
        ...
        return e.prototype.tick = function (e, t) {
            var n;
            return null == t && (t = k(this.source, "progress")), t >= 100 && (this.done = !0), t === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), this.catchup = (t - this.progress) / D.catchupTime, this.sinceLastUpdate = 0, this.last = t), t > this.progress && (this.progress += this.catchup * e), n = 1 - Math.pow(this.progress / 100, D.easeFactor), this.progress += n * this.rate * e, this.progress = Math.min(this.lastProgress + D.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
        }, e
    ...
    }), f = {ajax: e, elements: i, document: n, eventLag: o}, (j = function () {
        var e, n, i, r, o, s, a, l;
        for (c.sources = H = [], n = 0, r = (s = ["ajax", "elements", "document", "eventLag"]).length; r > n; n++) e = s[n], !1 !== D[e] && H.push(new f[e](D[e]));
        for (i = 0, o = (l = null != (a = D.extraSources) ? a : []).length; o > i; i++) q = l[i], H.push(new q(D));
        return c.bar = v = new t, I = [], R = new d
    })(), c.stop = function () {
        return c.trigger("stop"), c.running = !1, v.destroy(), y = !0, null != m && ("function" == typeof b && b(m), m = null), j()
    }, c.restart = function () {
        return c.trigger("restart"), c.stop(), c.start()
    }, c.go = function () {
        var e;
        return c.running = !0, v.render(), e = A(), y = !1, m = O(function (t, n) {
            var i, r, o, s, a, l, u, f, h, p, m, g, b, w, _;
            for (100 - v.progress, r = p = 0, o = !0, l = m = 0, b = H.length; b > m; l = ++m) for (q = H[l], h = null != I[l] ? I[l] : I[l] = [], a = null != (_ = q.elements) ? _ : [q], u = g = 0, w = a.length; w > g; u = ++g) s = a[u], f = null != h[u] ? h[u] : h[u] = new d(s), o &= f.done, f.done || (r++, p += f.tick(t));
            return i = p / r, v.update(R.tick(t, i)), v.done() || o || y ? (v.update(100), c.trigger("done"), setTimeout(function () {
    ...
    return function () {
        ...
        1: [function (e, t, n) {
            var i = e("./lib/execute-scripts.js"), r = e("./lib/foreach-els.js"), o = e("./lib/parse-options.js"),
                ...
                c = e("./lib/events/trigger.js"), u = e("./lib/util/clone.js"), f = e("./lib/util/contains.js"),
                d = e("./lib/util/extend.js"), h = e("./lib/util/noop"), p = function (e) {
                    this.state = {
            ...
            if (p.switches = s, p.prototype = {
                ...
                loadContent: function (e, t) {
                    ...
                    })), n.documentElement.innerHTML = e, this.log("load content", n.documentElement.attributes, n.documentElement.innerHTML.length), document.activeElement && f(document, this.options.selectors, document.activeElement)) try {
                ...
                loadUrl: function (e, t) {
                    t = "object" == typeof t ? d({}, this.options, t) : u(this.options), this.log("load href", e, t), this.abortRequest(this.request), c(document, "pjax:send", t), this.request = this.doRequest(e, t, this.handleResponse.bind(this))
                },
            ...
            }, p.isSupported = e("./lib/is-supported.js"), p.isSupported()) t.exports = p; else {
                var m = h;
                for (var g in p.prototype) p.prototype.hasOwnProperty(g) && "function" == typeof p.prototype[g] && (m[g] = h);
                t.exports = m
            }
        }, {
            ...
            t.exports = function (e, t, n) {
                ...
                return t.cacheBust && (e = i(e, "t", Date.now())), u.open(s, e, !0), u.timeout = f, u.setRequestHeader("X-Requested-With", "XMLHttpRequest"), u.setRequestHeader("X-PJAX", "true"), u.setRequestHeader("X-PJAX-Selectors", JSON.stringify(t.selectors)), c && "POST" === s && u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), u.send(c), u
            }
            ...
            t.exports = {
                outerHTML: function (e, t) {
                    ...
                    var o = Array.prototype.forEach, s = [], a = [], l = document.createDocumentFragment(),
                        c = "animationend webkitAnimationEnd MSAnimationEnd oanimationend", u = 0, f = function (e) {
...
var MODULE_CONFIG = {
    ...
    scrollreveal: ["../libs/scrollreveal/dist/scrollreveal.min.js", "../assets/js/plugins/jquery.scrollreveal.js"],
    ...
    html5sortable: ["../libs/html5sortable/dist/html.sortable.min.js", "../assets/js/plugins/jquery.html5sortable.js", "../assets/js/plugins/sortable.js"],
    easyPieChart: ["../libs/easy-pie-chart/dist/jquery.easypiechart.min.js"],
    peity: ["../libs/peity/jquery.peity.js", "../assets/js/plugins/jquery.peity.tooltip.js"],
    chart: ["../libs/moment/min/moment-with-locales.min.js", "../libs/chart.js/dist/Chart.min.js", "../assets/js/plugins/jquery.chart.js", "../assets/js/plugins/chartjs.js"],
    dataTable: ["../libs/datatables/media/js/jquery.dataTables.min.js", "../libs/datatables.net-bs4/js/dataTables.bootstrap4.js", "../libs/datatables.net-bs4/css/dataTables.bootstrap4.css", "../assets/js/plugins/datatable.js"],
    ...
    datetimepicker: ["../libs/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css", "../libs/moment/min/moment-with-locales.min.js", "../libs/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js", "../assets/js/plugins/datetimepicker.js"],
    ...
    fullCalendar: ["../libs/moment/min/moment-with-locales.min.js", "../libs/fullcalendar/dist/fullcalendar.min.js", "../libs/fullcalendar/dist/fullcalendar.min.css", "../assets/js/plugins/fullcalendar.js"],
    ...
    waves: ["../libs/node-waves/dist/waves.min.css", "../libs/node-waves/dist/waves.min.js", "../assets/js/plugins/waves.js"]
...
!function (e, t) {
    ...
    $.fn.plugin = function () {
        return this.each(function () {
            var self = $(this), opts = self.attr("data-option") || self.attr("data-plugin-option"),
                attr = self.attr("data-plugin"), options = opts && eval("[" + opts + "]");
...
}(jQuery, MODULE_CONFIG, MODULE_OPTION_CONFIG), function (e) {
    "use strict";
    ...
    e.extend(jQuery.easing, {
        def: "easeOutQuad", easeInOutExpo: function (e, t, n, i, r) {
        ...
        n && e("html,body").animate({scrollTop: n.offset().top}, 600, "easeInOutExpo")
    })
}(jQuery), function (e) {
    "use strict";
    e(document).on("click", "[data-toggle-class]", function (t) {
        ...
        var n = e(this), i = n.attr("data-toggle-class"),
            r = n.attr("data-toggle-class-target") || n.attr("data-target"), o = i && i.split(",") || "",
            s = r && r.split(",") || Array(n), a = 0;
        e.each(o, function (t, n) {
            var i = e(s[s.length && a]), r = i.attr("data-class"), l = o[t];
    ...
    window.app = {
        color: {primary: "#2499ee", accent: "#6284f3", warn: "#907eec"},
        setting: {
            ajax: !0,
            folded: !1,
            container: !1,
    ...
    if (e(document).on("pjax:send", function () {
        ...
        switches: {"#content-main": Pjax.switches.sideBySide},
        switchesOptions: {"#content-main": t}
    }), i = new Pjax({
        cacheBust: !1,
...
/* ADF Custome JQUERY */
$(".asc").before("<i class='fa fa-sort-down align-text-center'></i> ");
$(".desc").before("<i class='fa fa-sort-up align-text-center'></i> ");
$(".sortable").before("<i class='fa fa-sort align-text-center'></i> ");